...
from .client_selection_algorithms.reputation_based.reputation_based_server import ReputationBasedServer
...
from .client_selection_algorithms.reputation_based.reputation_based_client import ReputationBasedClient
...
class CSAlgo(Enum):
    ...
    REPUTATION = Entity(ReputationBasedServer, ReputationBasedClient)
