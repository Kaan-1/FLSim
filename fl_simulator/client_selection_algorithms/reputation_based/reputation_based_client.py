...
def get_updates(client, global_model_slope, global_model_constant):
    ...
    # add the response time of the client in the return tuple
    # in the real life setting, the server is responsible for timing the clients
    # but I added it here because it was much easier implement
    response_time = client.download_time + client.computation_time + client.upload_time
